# Blood Bank Management System (Node.js/Express/MongoDB Backend)

**Note:** A new backend is being added in the `backend/` folder using Node.js, Express, and MongoDB. The legacy PHP files will be replaced module by module with a modern full stack implementation.
